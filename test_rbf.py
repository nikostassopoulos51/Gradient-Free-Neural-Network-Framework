...
def train_layer_1_rbf(neurons, vars, obs, n_per_part, inds_all, x, y, cc):
    ...
    print("Computing RBF layer outputs...")
...
plt.plot(items_per_neuron)
plt.xlabel('Neuron Index')
plt.ylabel('Number of Items')
plt.title('Items per Neuron in Clustering')
plt.show()

# Train RBF Network
cc = 1.0
a_all, a_layer1, layer1 = train_layer_1_rbf(total_neurons, x_train_scaled.shape[1], len(x_train), n_per_part, inds_all, x_train_scaled, y_train, cc)
